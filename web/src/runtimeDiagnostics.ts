export interface RuntimeDiagnostics {
  ...
  preparedGraph: { nodeCount: number; connectionCount: number; feedbackRegionCount: number; blockWiseRegionCount: number; sampleWiseRegionCount: number; logicalAudioBufferCount: number; logicalSignalCount: number; elidedNonAudioBufferCount: number; physicalAudioBufferCount: number; peakLiveBufferCount: number; bufferBytesSaved: number; inPlaceAliasCount: number; copiesAvoided: number; bufferRetentionReasons: { reason: string; signalCount: number }[]; preparedStorageBytes: number; compileTiming: { validationMicroseconds: number; schedulingMicroseconds: number; preparationMicroseconds: number; totalMicroseconds: number; requestToActiveMicroseconds: number } };
