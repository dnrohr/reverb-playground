...
describe('factory patches', () => {
  it('matches the complete licensed and traceable factory catalog', () => {
    ...
    expect(catalog.patches.map((patch) => patch.family)).toEqual(['barr-reference', 'reverse-style', 'gated', 'modulated-reverse-style', 'gravity-diffusion', 'dense-figure-eight', 'four-line-fdn', 'parallel-shimmer', 'feedback-shimmer', 'reverse-cosmic-shimmer']);
  ...
  it.each(['causal-reverse-envelope', 'level-gated-room', 'modulated-cosmic-reverse', 'gravity-diffusion', 'dense-figure-eight', 'four-line-dense-room', 'safe-parallel-shimmer', 'split-feedback-shimmer', 'reverse-cosmic-shimmer'] as const)(
