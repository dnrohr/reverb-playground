...
const diagnostic = {
  ...
  preparedGraph: { nodeCount: 12, connectionCount: 15, feedbackRegionCount: 1, preparedStorageBytes: 48000, compileTiming: { validationMicroseconds: 10, schedulingMicroseconds: 20, preparationMicroseconds: 30, totalMicroseconds: 60, requestToActiveMicroseconds: 150 } },
